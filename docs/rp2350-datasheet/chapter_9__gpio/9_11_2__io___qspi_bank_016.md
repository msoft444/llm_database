...
*Table 819. USBPHY_DP_STATUS Register IO_QSPI: USBPHY_DP_CTRL Register*

Offset: 0x004

*Table 820. Bits Description Type Reset USBPHY_DP_CTRL Register*
...
*Table 821. USBPHY_DM_STATUS Register IO_QSPI: USBPHY_DM_CTRL Register*
...
*Table 823. GPIO_QSPI_SCLK_STA TUS Register IO_QSPI: GPIO_QSPI_SCLK_CTRL Register*

Offset: 0x014

*Table 824. Bits Description Type Reset GPIO_QSPI_SCLK_CTR L Register*
...
*Table 825. GPIO_QSPI_SS_STATU S Register IO_QSPI: GPIO_QSPI_SS_CTRL Register*
...
*Table 827. GPIO_QSPI_SD0_STAT US Register IO_QSPI: GPIO_QSPI_SD0_CTRL Register*

Offset: 0x024

*Table 828. Bits Description Type Reset GPIO_QSPI_SD0_CTRL Register*
...
*Table 829. GPIO_QSPI_SD1_STAT US Register IO_QSPI: GPIO_QSPI_SD1_CTRL Register*
...
*Table 831. GPIO_QSPI_SD2_STAT US Register IO_QSPI: GPIO_QSPI_SD2_CTRL Register*

Offset: 0x034

*Table 832. Bits Description Type Reset GPIO_QSPI_SD2_CTRL Register*
...
*Table 833. GPIO_QSPI_SD3_STAT US Register IO_QSPI: GPIO_QSPI_SD3_CTRL Register*
...
*Table 835. IRQSUMMARY_PROC0 _SECURE Register IO_QSPI: IRQSUMMARY_PROC0_NONSECURE Register*
...
*Table 836. IRQSUMMARY_PROC0 _NONSECURE Register IO_QSPI: IRQSUMMARY_PROC1_SECURE Register*
...
*Table 838. IRQSUMMARY_PROC1 _NONSECURE Register IO_QSPI: IRQSUMMARY_COMA_WAKE_SECURE Register*
...
*Table 839. IRQSUMMARY_COMA_ WAKE_SECURE Register*
