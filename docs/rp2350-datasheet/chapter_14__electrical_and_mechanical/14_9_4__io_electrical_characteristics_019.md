...
| --- | --- | --- | --- | --- | --- | --- |
| Pin Input Leakage Current | I IN |  |  | 1 | μA |  |
| Input Voltage | V IH | IOVDD=1.8V | 0.65 * IOVDD | IOVDD + 0.3 | V |  |
| High (Standard IO) |  | IOVDD=2.5V | 1.7 | IOVDD + 0.3 | V |  |
|  |  | IOVDD=3.3V | 2 | IOVDD + 0.3 | V |  |
| Input Voltage High (FT) | V IH | IOVDD=1.8V | 0.65 * IOVDD | 3.63 | V | IOVDD must be powered to |
|  |  | IOVDD=2.5V | 1.7 | 4.2 | V | tolerate input |
|  |  | IOVDD=3.3V | 2 | 5.5 | V | voltages above 3.63V |
| Input Voltage | V IL | IOVDD=1.8V | -0.3 | 0.35 * IOVDD | V |  |
| Low |  | IOVDD=2.5V | -0.3 | 0.7 | V |  |
|  |  | IOVDD=3.3V | -0.3 | 0.8 | V |  |
| Input | V HYS | IOVDD=1.8V | 0.1 * IOVDD |  | V | Schmitt Trigger |
| Hysteresis Voltage |  | IOVDD=2.5V | 0.2 |  | V | enabled |
|  |  | IOVDD=3.3V | 0.2 |  | V |  |
| Output Voltage | V OH | IOVDD=1.8V | 1.24 | IOVDD | V | I = 2, 4, 8 or OH |
| High |  | IOVDD=2.5V | 1.78 | IOVDD | V | 12mA depending on |
|  |  | IOVDD=3.3V | 2.62 | IOVDD | V | setting |
| Output Voltage | V OL | IOVDD=1.8V | 0 | 0.3 | V | I = 2, 4, 8 or OL |
| Low |  | IOVDD=2.5V | 0 | 0.4 | V | 12mA depending on |
|  |  | IOVDD=3.3V | 0 | 0.5 | V | setting |
| Pull-Up | R PU | IOVDD=1.8V | 32 | 106 | kΩ |  |
| Resistance |  | IOVDD=2.5V | 42 | 123 | kΩ |  |
|  |  | IOVDD=3.3V | 32 | 86 | kΩ |  |
| Pull-Down | R PD | IOVDD=1.8V | 35 | 189 | kΩ |  |
...
*Table 1436. Digital IO characteristics - Standard and FT unless otherwise*
