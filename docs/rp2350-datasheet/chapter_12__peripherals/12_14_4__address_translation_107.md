...
![Page 1235 figure](images/fig_p1235_1.png)
...
![Page 1235 figure](images/fig_p1235_2.png)

Window 0
(Physical)

*Figure 140. By default, each window is set up to map the full 16 MB Window 0 (Virtual) virtual address space directly 1:1 with the 16 MB physical address space. Window 0(Physical) ranging from 0 to 4 MB.*

*Figure 141. The BASE of a pane defines where its physical Window 0 (Virtual) mapping begins. The SIZE defines how far it extends. A SIZE of 0 means no addresses are mapped through that pane. Window 0(Physical)*
