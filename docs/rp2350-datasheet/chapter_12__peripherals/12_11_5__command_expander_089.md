...
*Figure 128. A mixture of commands and data are popped from the FIFO. Data can be repeated or shifted through the expansion shift register, and From optionally passed FIFO through an encoder before passing on to the output shift register.*
