...
![Page 994 figure](images/fig_p0994_1.png)
...
![Page 994 figure](images/fig_p0994_2.png)
...
![Page 994 figure](images/fig_p0994_3.png)
...
*Figure 77. Master Transmitter - TX FIFO SDA Empties/STOP SCL Generation FIFO_EMPTY Receiver - TX FIFO SDA Empties/STOP SCL Generation FIFO_EMPTY as a master transmitter.*
...
![Page 995 figure](images/fig_p0995_1.png)
...
![Page 995 figure](images/fig_p0995_2.png)
...
![Page 995 figure](images/fig_p0995_3.png)
...
![Page 995 figure](images/fig_p0995_4.png)
...
![Page 995 figure](images/fig_p0995_5.png)
...
*Figure 79. Master Transmitter - Restart SDA Bit of IC_DATA_CMD SCL Is Set FIFO_EMPTY Receiver - Restart Bit SDA of IC_DATA_CMD Is SCL Set FIFO_EMPTY FIFO is not empty.*

*Figure 81. Master Transmitter - Stop Bit SDA of IC_DATA_CMD SCL Set/TX FIFO not empty FIFO_EMPTY*

*Figure 82. Master Transmitter - First SDA Byte Loaded Into TX SCL FIFO Allowed to FIFO_EMPTY Empty, Restart Bit Set FIFO is not empty. Receiver - Stop Bit of SDA IC_DATA_CMD Set/TX SCL FIFO Not Empty FIFO_EMPTY*
