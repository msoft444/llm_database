...
*Figure 13. The redundancy Opcode Phase Data Phase CPOPC CPRDATA[31:0] CPWDATA[63:0]*
...
*Figure 14. Triggering an RCP fault on one core also triggers a Core 0 Trigger fault on the other core. Triggers accumulate into a fault register, which remains set until the core resets. The NMI asserts when the fault register is set. register.*
