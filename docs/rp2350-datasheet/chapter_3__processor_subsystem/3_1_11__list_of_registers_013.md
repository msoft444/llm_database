...
*Table 19. GPIO_IN SIO: GPIO_HI_IN Register Offset: 0x008 Description*
...
*Table 20. GPIO_HI_IN SIO: GPIO_OUT Register Offset: 0x010 Description*

GPIO0…31 output value

*Table 21. GPIO_OUT SIO: GPIO_HI_OUT Register Offset: 0x014 Description*
...
*Table 22. SIO: GPIO_OUT_SET Register Offset: 0x018 Description*
...
*Table 23. GPIO_OUT_SET Register SIO: GPIO_HI_OUT_SET Register*
...
*Table 24. GPIO_HI_OUT_SET Register SIO: GPIO_OUT_CLR Register*
...
*Table 25. GPIO_OUT_CLR Register SIO: GPIO_HI_OUT_CLR Register*
...
*Table 26. GPIO_HI_OUT_CLR Register SIO: GPIO_OUT_XOR Register*
...
*Table 27. GPIO_OUT_XOR Register SIO: GPIO_HI_OUT_XOR Register*
...
*Table 28. GPIO_HI_OUT_XOR Register SIO: GPIO_OE Register*
...
*Table 32. GPIO_HI_OE_SET Register SIO: GPIO_OE_CLR Register*
...
*Table 34. GPIO_HI_OE_CLR Register SIO: GPIO_OE_XOR Register*
...
*Table 35. GPIO_OE_XOR Register SIO: GPIO_HI_OE_XOR Register*
...
*Table 36. GPIO_HI_OE_XOR Register SIO: FIFO_ST Register*
...
*Table 40. SPINLOCK_ST Register SIO: INTERP0_ACCUM0 Register*
...
*Table 41. INTERP0_ACCUM0 Register SIO: INTERP0_ACCUM1 Register*
...
*Table 42. INTERP0_ACCUM1 Register SIO: INTERP0_BASE0 Register*

Offset: 0x088

*Table 43. INTERP0_BASE0 Register SIO: INTERP0_BASE1 Register*
...
*Table 44. INTERP0_BASE1 Register SIO: INTERP0_BASE2 Register*
...
*Table 45. INTERP0_BASE2 Register SIO: INTERP0_POP_LANE0 Register*
...
*Table 46. INTERP0_POP_LANE0 Register SIO: INTERP0_POP_LANE1 Register*
...
*Table 47. INTERP0_POP_LANE1 Register SIO: INTERP0_POP_FULL Register*
...
*Table 48. INTERP0_POP_FULL Register SIO: INTERP0_PEEK_LANE0 Register*
...
*Table 49. INTERP0_PEEK_LANE 0 Register SIO: INTERP0_PEEK_LANE1 Register*

Offset: 0x0a4

*Table 50. INTERP0_PEEK_LANE 1 Register SIO: INTERP0_PEEK_FULL Register*
...
*Table 51. INTERP0_PEEK_FULL Register SIO: INTERP0_CTRL_LANE0 Register*
...
*Table 53. INTERP0_CTRL_LANE 1 Register SIO: INTERP0_ACCUM0_ADD Register*

Offset: 0x0b4

*Table 54. INTERP0_ACCUM0_AD D Register SIO: INTERP0_ACCUM1_ADD Register*
...
*Table 55. INTERP0_ACCUM1_AD D Register SIO: INTERP0_BASE_1AND0 Register*
...
*Table 56. INTERP0_BASE_1AND 0 Register SIO: INTERP1_ACCUM0 Register*
...
*Table 57. INTERP1_ACCUM0 Register SIO: INTERP1_ACCUM1 Register*
...
*Table 58. INTERP1_ACCUM1 Register SIO: INTERP1_BASE0 Register*
...
*Table 59. INTERP1_BASE0 Register SIO: INTERP1_BASE1 Register*

Offset: 0x0cc

*Table 60. INTERP1_BASE1 Register SIO: INTERP1_BASE2 Register*
...
*Table 61. INTERP1_BASE2 Register SIO: INTERP1_POP_LANE0 Register*
...
*Table 62. INTERP1_POP_LANE0 Register SIO: INTERP1_POP_LANE1 Register*
...
*Table 63. INTERP1_POP_LANE1 Register SIO: INTERP1_POP_FULL Register*
...
*Table 64. INTERP1_POP_FULL Register SIO: INTERP1_PEEK_LANE0 Register*
...
*Table 65. INTERP1_PEEK_LANE 0 Register SIO: INTERP1_PEEK_LANE1 Register*
...
*Table 66. INTERP1_PEEK_LANE 1 Register SIO: INTERP1_PEEK_FULL Register*

Offset: 0x0e8

*Table 67. INTERP1_PEEK_FULL Register SIO: INTERP1_CTRL_LANE0 Register*
...
*Table 68. INTERP1_CTRL_LANE 0 Register SIO: INTERP1_CTRL_LANE1 Register*
...
*Table 69. INTERP1_CTRL_LANE 1 Register SIO: INTERP1_ACCUM0_ADD Register*
...
*Table 70. INTERP1_ACCUM0_AD D Register SIO: INTERP1_ACCUM1_ADD Register*
...
*Table 71. INTERP1_ACCUM1_AD D Register SIO: INTERP1_BASE_1AND0 Register*
...
*Table 73. SPINLOCK0, SPINLOCK1, …, SPINLOCK30, SPINLOCK31*
...
*Table 74. DOORBELL_OUT_SET Register SIO: DOORBELL_OUT_CLR Register*

Offset: 0x184

*Table 75. DOORBELL_OUT_CLR Register SIO: DOORBELL_IN_SET Register*
...
*Table 76. DOORBELL_IN_SET Register SIO: DOORBELL_IN_CLR Register*
...
*Table 77. DOORBELL_IN_CLR Register SIO: PERI_NONSEC Register*
...
*Table 79. RISCV_SOFTIRQ Register SIO: MTIME_CTRL Register*
...
*Table 84. SIO: TMDS_CTRL Register Offset: 0x1c0 Description*
...
*Table 86. TMDS_WDATA Register SIO: TMDS_PEEK_SINGLE Register*
...
*Table 87. TMDS_PEEK_SINGLE Register SIO: TMDS_POP_SINGLE Register*

Offset: 0x1cc

*Table 88. TMDS_POP_SINGLE Register SIO: TMDS_PEEK_DOUBLE_L0 Register*
...
*Table 89. TMDS_PEEK_DOUBLE_ L0 Register SIO: TMDS_POP_DOUBLE_L0 Register*
...
*Table 90. TMDS_POP_DOUBLE_L 0 Register SIO: TMDS_PEEK_DOUBLE_L1 Register*
...
*Table 91. TMDS_PEEK_DOUBLE_ L1 Register SIO: TMDS_POP_DOUBLE_L1 Register*

Offset: 0x1dc

*Table 92. TMDS_POP_DOUBLE_L 1 Register SIO: TMDS_PEEK_DOUBLE_L2 Register*
...
*Table 93. TMDS_PEEK_DOUBLE_ L2 Register SIO: TMDS_POP_DOUBLE_L2 Register*
