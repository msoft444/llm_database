...
Workaround
If any WATCHDOG based reboot types other than into the regular boot path aren’t required (this includes
...
RP2350 A2
Description
An attacker with physical access to the chip, could precisely time physical glitch attacks during entry to
