...
Description
RP2350 bus fabric consists mainly of an AHB5 crossbar, where 6 upstream ports (managers) are routed
...
Workaround
There is no complete fix, but the necessary prioritisation can often still be achieved by configuring
