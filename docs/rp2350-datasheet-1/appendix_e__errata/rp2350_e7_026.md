...
Workaround
Either configure your debug translator to not use SBA, or don’t enter clock-gated sleep on core 1. The A2
...
Workaround
When configuring PMP with X != R, use the bit order implemented by this version of Hazard3. In the SDK,
