...
![Page 55 figure](images/fig_p0055.png)
...
Perform an atomic bit-set on GPIO_HI_OUT, i.e. GPIO HI OUT |=
_ _
wdata |
...
Perform an atomic bit-clear on GPIO_HI_OUT, i.e. GPIO HI OUT &=
_ _
~wdata |
...
![Page 56 figure](images/fig_p0056.png)
...
Perform an atomic bitwise XOR on GPIO_HI_OUT, i.e. GPIO HI OUT
_ _
^= wdata |
...
Perform an atomic bit-set on GPIO_HI_OE, i.e. GPIO HI OE |= wdata
_ _ |
...
![Page 57 figure](images/fig_p0057.png)
...
![Page 58 figure](images/fig_p0058.png)
...
![Page 59 figure](images/fig_p0059.png)
...
![Page 60 figure](images/fig_p0060.png)
...
![Page 61 figure](images/fig_p0061.png)
...
![Page 62 figure](images/fig_p0062.png)
...
![Page 63 figure](images/fig_p0063.png)
...
| Bits | Description | Type | Reset |
| --- | --- | --- | --- |
| 31:0 | Perform an atomic bit-set on GPIO_OUT, i.e. GPIO OUT |= wdata
_ | WO | 0x00000000 |
...
![Page 64 figure](images/fig_p0064.png)
...
| Bits | Description | Type | Reset |
| --- | --- | --- | --- |
| 31:0 | Perform an atomic bit-clear on GPIO_OUT, i.e. GPIO OUT &= ~wdata
_ | WO | 0x00000000 |
...
| Bits | Description | Type | Reset |
| --- | --- | --- | --- |
| 31:0 | Perform an atomic bitwise XOR on GPIO_OUT, i.e. GPIO OUT ^= wdata
_ | WO | 0x00000000 |
...
![Page 65 figure](images/fig_p0065.png)
...
![Page 66 figure](images/fig_p0066.png)
...
| Bits | Description | Type | Reset |
| --- | --- | --- | --- |
| 31:0 | Perform an atomic bit-set on GPIO_OE, i.e. GPIO OE |= wdata
_ | WO | 0x00000000 |
...
| Bits | Description | Type | Reset |
| --- | --- | --- | --- |
| 31:0 | Perform an atomic bit-clear on GPIO_OE, i.e. GPIO OE &= ~wdata
_ | WO | 0x00000000 |
...
![Page 67 figure](images/fig_p0067.png)
...
| Bits | Description | Type | Reset |
| --- | --- | --- | --- |
| 31:0 | Perform an atomic bitwise XOR on GPIO_OE, i.e. GPIO OE ^= wdata
_ | WO | 0x00000000 |
...
![Page 68 figure](images/fig_p0068.png)
...
![Page 69 figure](images/fig_p0069.png)
...
![Page 70 figure](images/fig_p0070.png)
...
![Page 71 figure](images/fig_p0071.png)
...
Setting MSB < LSB may cause chip to turn inside-out | RW | 0x00 |
...
![Page 72 figure](images/fig_p0072.png)
...
![Page 73 figure](images/fig_p0073.png)
...
![Page 74 figure](images/fig_p0074.png)
...
- Signedness of these comparisons is determined by LANE0_CTRL_SIGNED | RW | 0x0 |
| 21 | Reserved. | - | - |
| 20:19 | FORCE_MSB: ORed into bits 29:28 of the lane result presented to the
processor on the bus.
No effect on the internal 32-bit datapath. Handy for using a lane to generate
...
![Page 75 figure](images/fig_p0075.png)
...
![Page 76 figure](images/fig_p0076.png)
...
![Page 77 figure](images/fig_p0077.png)
...
![Page 78 figure](images/fig_p0078.png)
...
![Page 79 figure](images/fig_p0079.png)
...
![Page 80 figure](images/fig_p0080.png)
...
![Page 81 figure](images/fig_p0081.png)
...
![Page 82 figure](images/fig_p0082.png)
