...
![Page 133 figure](images/fig_p0133.png)
...
![Page 134 figure](images/fig_p0134.png)
...
![Page 135 figure](images/fig_p0135.png)
...
MSP NS for the Non-secure state, and MSP S for the Secure
_ _
state. |
...
PSP NS for the Non-secure state, and PSP S for the Secure
_ _
state. |
...
![Page 136 figure](images/fig_p0136.png)
...
Cortex-M33 processor: PRIMASK NS for the Non-secure state
_
and PRIMASK S for the Secure state.
_ |
| BASEPRI | The BASEPRI register defines the minimum priority for
exception processing. There are two BASEPRI registers in
the Cortex-M33 processor: BASEPRI NS for the Non-secure
_
state, and BASEPRI S for the Secure state.
_ |
...
Cortex-M33 processor: FAULTMASK NS for the Non-secure
_
state, and FAULTMASK S for the Secure state.
_ |
...
processor: CONTROL NS for the Non-secure state and
_
CONTROL S for the Secure state.
_ |
...
![Page 140 figure](images/fig_p0140.png)
...
![Page 141 figure](images/fig_p0141.png)
...
![Page 143 figure](images/fig_p0143.png)
...
![Page 144 figure](images/fig_p0144.png)
...
![Page 147 figure](images/fig_p0147.png)
...
![Page 148 figure](images/fig_p0148.png)
