...
![Page 459 figure](images/fig_p0459.png)
...
![Page 460 figure](images/fig_p0460.png)
...
![Page 462 figure](images/fig_p0462.png)
...
![Page 463 figure](images/fig_p0463.png)
...
![Page 464 figure](images/fig_p0464.png)
...
![Page 465 figure](images/fig_p0465.png)
...
0=startup complete, 1=starting up | RO | 0x0 |
...
writes to the vreg register will be ignored when this field is set | RO | 0x0 |
| 14:9 | Reserved. | - | - |
...
![Page 466 figure](images/fig_p0466.png)
...
0=not in high impedance mode, 1=in high impedance mode | RW | 0x0 |
| 0 | Reserved. | - | - |
...
![Page 467 figure](images/fig_p0467.png)
...
![Page 468 figure](images/fig_p0468.png)
...
![Page 469 figure](images/fig_p0469.png)
...
01111 - 1.118V
10000 - 1.161
10001 - 1.204V | RW | 0x0b |
| 3:1 | Reserved. | - | - |
| 0 | EN: enable brown-out detection
0=not enabled, 1=enabled | RW | 0x1 |
...
![Page 470 figure](images/fig_p0470.png)
...
| 3:1 | Reserved. | - | - |
| 0 | EN: enable brown-out detection
0=not enabled, 1=enabled | RW | 0x0 |
...
![Page 471 figure](images/fig_p0471.png)
...
swcore no
psm yes
and does not change the power state | RO | 0x0 |
...
![Page 472 figure](images/fig_p0472.png)
...
swcore yes
psm yes
then starts the power sequencer | RO | 0x0 |
...
![Page 473 figure](images/fig_p0473.png)
...
![Page 474 figure](images/fig_p0474.png)
...
![Page 475 figure](images/fig_p0475.png)
...
reset for the switched core power domain | RW | 0x0 |
| 7:5 | Reserved. | - | - |
...
This relies on clk_ref running. Use reset_powman_async if that may not be true | RW | 0x0 |
| 3:1 | Reserved. | - | - |
...
(PSM) sequence
This does not rely on clk_ref running | RW | 0x0 |
...
This setting takes effect when a power up sequence is next run | RW | 0x1 |
| 11:9 | Reserved. | - | - |
...
![Page 476 figure](images/fig_p0476.png)
...
This setting takes effect when the swcore is next powered down | RW | 0x1 |
| 7 | USE_BOD_HP: Set to 0 to prevent automatic switching to bod high power
mode when switched-core is powered up
This setting takes effect when the swcore is next powered up | RW | 0x1 |
...
![Page 477 figure](images/fig_p0477.png)
...
and is waiting for other actions to complete before executing it | RO | 0x0 |
| 11 | BAD_HW_REQ: Invalid hardware initiated state request, power up requests
actioned, power down requests ignored | RO | 0x0 |
...
ignored because of a pending power state change request | WC | 0x0 |
| 8 | REQ_IGNORED: Indicates that a software state change request was ignored
because it clashed with an ongoing hardware or debugger request | WC | 0x0 |
...
when clk_pow is running from the fast clock it is divided by tick_div | RW | 0x040 |
...
steps
measured in units of the powman tick period (>=1us), 0 gives a delay of 1 unit | RW | 0x20 |
| 7:4 | XIP_STEP: timing between the xip power state machine steps
measured in units of the lposc period, 0 gives a delay of 1 unit | RW | 0x1 |
...
![Page 478 figure](images/fig_p0478.png)
...
set to 31 to disable this feature | RW | 0x3f |
...
POWMAN_TIMER_USING_XOSC=1 | RW | 0x20 |
...
or POWMAN_TIMER_USING_XOSC=1 | RW | 0xc49c |
...
![Page 480 figure](images/fig_p0480.png)
...
POWMAN_TIMER_USING_XOSC=0 | RW | 0x2ee0 |
...
written when POWMAN_TIMER_RUN=0 or POWMAN_TIMER_USING_XOSC=0 | RW | 0x0000 |
...
must only be written when POWMAN_TIMER_RUN=0 | RW | 0x0000 |
...
![Page 481 figure](images/fig_p0481.png)
...
![Page 482 figure](images/fig_p0482.png)
...
POWMAN_TIMER_USE_XOSC=1 | RW | 0x0 |
...
![Page 487 figure](images/fig_p0487.png)
...
paying attention to pwrup_req | RW | 0x0 |
...
![Page 488 figure](images/fig_p0488.png)
