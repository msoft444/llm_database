...
| --- | --- | --- | --- | --- | --- |
| DVDD
TH.POR | power-on reset
threshold | 0.924 | 0.957 | 0.99 | V |
| t
POR.ASSERT | power-on reset
assertion delay |  | 3 | 10 | μs |
...
| --- | --- | --- | --- | --- | --- |
| DVDD
TH.BOD.ASSERT | brownout
detection
assertion
threshold | 96.5 | 100 | 103.5 | % of selected
threshold voltage |
| DVDD
TH.BOD.DEASSERT | brownout
detection de-
assertion
threshold | 97.4 | 101 | 105 | % of selected
threshold voltage |
| t
BOD.ACTIVE | brownout
detection
activation delay |  | 55 | 80 | μs |
| t
BOD.ASSERT | brownout
detection
assertion delay |  | 3 | 10 | μs |
