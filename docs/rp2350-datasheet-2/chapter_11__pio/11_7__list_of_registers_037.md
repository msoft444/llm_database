...
![Page 941 figure](images/fig_p0941.png)
...
![Page 942 figure](images/fig_p0942.png)
...
![Page 943 figure](images/fig_p0943.png)
...
![Page 944 figure](images/fig_p0944.png)
...
![Page 945 figure](images/fig_p0945.png)
...
those PIOs' CTRL registers. | SC | 0x0 |
...
![Page 946 figure](images/fig_p0946.png)
...
(SMx_CLKDIV) have been changed on-the-fly. | SC | 0x0 |

11.7. List of registers
945

![Page 947 figure](images/fig_p0947.png)
...
PULL, or an OUT with autopull enabled. Write 1 to clear. | WC | 0x0 |
| 23:20 | Reserved. | - | - |
...
![Page 948 figure](images/fig_p0948.png)
...
![Page 949 figure](images/fig_p0949.png)
...
The data returned to the system on a read from an empty FIFO is undefined. | RF | - |
...
alongside FIFO status interrupts — see e.g. IRQ0_INTE. | WC | 0x00 |
...
not visible to the state machines. | WF | 0x00 |
...
0 → input is synchronized (default)
1 → synchronizer is bypassed
If in doubt, leave this register as all zeroes. | RW | 0x00000000 |
...
![Page 950 figure](images/fig_p0950.png)
...
![Page 951 figure](images/fig_p0951.png)
...
Value of 0 is interpreted as 65536. If INT is 0, FRAC must also be 0. | RW | 0x0001 |
...
latched by the state machine. Will clear to 0 once this instruction completes. | RO | 0x0 |
...
PINCTRL_SIDESET_COUNT is inclusive of this enable bit. | RW | 0x0 |
...
behaviour
due to the priority ordering of state machine pin writes (SM0 < SM1 < …) | RW | 0x0 |
...
than the current FIFO depth are reserved, and have undefined behaviour. | RW | 0x00 |
|  | Enumerated values: |  |  |
...
FIFOs are flushed when this bit is changed. | RW | 0x0 |
...
Write 0 for value of 32. | RW | 0x00 |
...
![Page 953 figure](images/fig_p0953.png)
...
Setting this bit will clear the FJOIN_TX and FJOIN_RX bits. | RW | 0x0 |
...
otherwise has no way of masking pins. | RW | 0x00 |
...
![Page 954 figure](images/fig_p0954.png)
...
0 (all delay bits, no side-set) and maximum of 5 (all side-set, no delay). | RW | 0x0 |
...
MOV PINS instruction. In the range 0 to 32 inclusive. | RW | 0x00 |
...
more-significant data bits, with a modulo of 32 applied to pin number. | RW | 0x00 |
...
written to this pin, with more-significant bits written to higher-numbered pins. | RW | 0x00 |
...
be the least-significant bit of the OUT or MOV data. | RW | 0x00 |
...
SHIFTCTRL_FJOIN_RX_PUT xor SHIFTCTRL_FJOIN_RX_GET is set. | RW | 0x00000000 |
...
![Page 955 figure](images/fig_p0955.png)
...
![Page 956 figure](images/fig_p0956.png)
...
![Page 957 figure](images/fig_p0957.png)
...
Only the values 0 and 16 are supported (only bit 4 is writable). | RW | 0x0 |
| 3:0 | Reserved. | - | - |
...
![Page 958 figure](images/fig_p0958.png)
...
![Page 959 figure](images/fig_p0959.png)
...
![Page 960 figure](images/fig_p0960.png)
...
![Page 961 figure](images/fig_p0961.png)
