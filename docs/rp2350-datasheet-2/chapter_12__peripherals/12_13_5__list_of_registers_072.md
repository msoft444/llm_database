...
![Page 1224 figure](images/fig_p1224.png)
...
![Page 1225 figure](images/fig_p1225.png)
...
message words lying around. | RW | 0x1 |
| 11:10 | Reserved. | - | - |
...
transfers can be requested per block. | RW | 0x2 |
|  | Enumerated values: |  |  |
|  | 0x0 → 8BIT |  |  |
|  | 0x1 → 16BIT |  |  |
|  | 0x2 → 32BIT |  |  |
...
not ready for data (WDATA_RDY is low). Write one to clear. | WC | 0x0 |
| 3 | Reserved. | - | - |
...
completes its digest. | RO | 0x1 |

12.13. SHA-256 accelerator
1224

![Page 1226 figure](images/fig_p1226.png)
...
transfers must not be mixed within a block. | WF | 0x00000000 |
