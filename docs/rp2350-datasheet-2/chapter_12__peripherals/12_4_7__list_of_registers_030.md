...
AINSEL will be updated after each conversion with the newly-selected channel. | RW | 0x000 |
...
bonded are available, and in the correct order | RW | 0x0 |
| 11 | Reserved. | - | - |
...
conversion will start immediately after the previous finishes. | RW | 0x0 |
...
same location if the sample is shifted. | RF | - |
| 14:12 | Reserved. | - | - |
| 11:0 | VAL | RF | - |
