...
![Page 1190 figure](images/fig_p1190.png)
...
always write timelw before timehw | WF | 0x00000000 |
...
writes do not get copied to time until timehw is written | WF | 0x00000000 |
...
always read timelr before timehr | RO | 0x00000000 |
...
![Page 1191 figure](images/fig_p1191.png)
...
Once armed, the alarm fires when TIMER_ALARM0 == TIMELR.
The alarm will disarm itself once it fires, and can
be disarmed early using the ARMED status register. | RW | 0x00000000 |
...
A write to the corresponding ALARMx register arms the alarm.
Alarms automatically disarm upon firing, but writing ones here
will disarm immediately without waiting to fire. | WC | 0x0 |
...
![Page 1192 figure](images/fig_p1192.png)
...
Once set, cannot be cleared (without a reset) | RW | 0x0 |
