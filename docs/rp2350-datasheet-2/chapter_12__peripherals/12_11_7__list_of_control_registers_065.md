...
![Page 1209 figure](images/fig_p1209.png)
...
![Page 1210 figure](images/fig_p1210.png)
...
A CLKDIV value of 0 is mapped to a period of 16 HSTX clock cycles. | RW | 0x1 |
...
full period), else its operation is undefined. | RW | 0x0 |
| 23:21 | Reserved. | - | - |
...
distance.)
A register value of 0 means shift 32 times. | RW | 0x05 |
| 15:13 | Reserved. | - | - |
...
when the product of SHIFT and N_SHIFTS is greater than 32. | RW | 0x06 |
| 7 | Reserved. | - | - |
...
![Page 1211 figure](images/fig_p1211.png)
...
19 are connected to the HSTX when coupled mode is engaged. | RW | 0x0 |
| 3:2 | Reserved. | - | - |
...
simultaneously with setting EN. | RW | 0x0 |
...
clock’s first rising edge will be one half-period after the first data is launched. | RW | 0x0 |
...
to generate an antiphase clock. | RW | 0x0 |
...
![Page 1212 figure](images/fig_p1212.png)
...
command (e.g. TMDS). A register value of 0 means shift 32 times. | RW | 0x01 |
| 23:21 | Reserved. | - | - |
...
A register value of 0 means shift 32 times. | RW | 0x01 |
| 7:5 | Reserved. | - | - |
