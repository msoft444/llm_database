...
be generated. See RNG_ISR for an explanation on this interrupt. | RW | 0x1 |
| 2 | CRNGT_ERR_INT_MASK: Set to 1 to mask (disable) this interrupt: no interrupt
will be generated. See RNG_ISR for an explanation on this interrupt. | RW | 0x1 |
| 1 | AUTOCORR_ERR_INT_MASK: Set to 1 to mask (disable) this interrupt: no
interrupt will be generated. See RNG_ISR for an explanation on this interrupt. | RW | 0x1 |
...
longer inverter chain lengths. | RW | 0x0 |
...
data can be read from EHR_DATA register. | RO | 0x0 |
...
* 0 - entropy source is disabled | RW | 0x0 |
...
sample counter must not be less than seventeen | RW | 0x0000ffff |
...
* 0 - debug mode is disabled | RW | 0x0 |
...
in order for the reset to take place. | RW | 0x0 |
...
* 0 - 20 SBOX AES | RO | 0x0 |
| 6 | RESEEDING_EXISTS: * 1 - Exists.
* 0 - Does not exist | RO | 0x0 |
