...
![Page 1010 figure](images/fig_p1010.png)
...
irrespective of whether master is active or not | RO | 0x0 |
...
only when the transmitted address matches the slave address (SAR). | RW | 0x0 |
|  | Enumerated values: |  |  |
...
also be written with a 0. | RW | 0x1 |
|  | Enumerated values: |  |  |
...
addressing - 1: 10-bit addressing | RW | 0x0 |
|  | Enumerated values: |  |  |
...
that match the full 10 bits of the IC_SAR register. | RW | 0x0 |
|  | Enumerated values: |  |  |
...
Note: This field is not applicable when IC_ULTRA_FAST_MODE=1 | RW | 0x2 |
|  | Enumerated values: |  |  |
...
should also be written with a '1'. | RW | 0x1 |
|  | Enumerated values: |  |  |
...
or GC_OR_START bit Reset value: 0x0 | RW | 0x0 |
|  | Enumerated values: |  |  |
...
value (bit 11) is cleared. - 1: START BYTE Reset value: 0x0 | RW | 0x0 |
|  | Enumerated values: |  |  |
...
transmit to itself; it can transmit to only a slave. | RW | 0x055 |
...
Table 1051 for a complete list of these reserved values. | RW | 0x055 |
...
(offset 0x11) if not interested in FIRST_DATA_BYTE status. | RO | 0x0 |
|  | Enumerated values: |  |  |
...
command is available in the Tx FIFO. Reset value: 0x0 | SC | 0x0 |
|  | Enumerated values: |  |  |
...
when this counter reaches a value of IC_SS_SCL_HCNT + 10. | RW | 0x0028 |
...
![Page 1018 figure](images/fig_p1018.png)
...
and then the upper byte is programmed. | RW | 0x002f |
...
APB_DATA_WIDTH == 8 the order of programming is important to ensure the
correct operation of the DW_apb_i2c. The lower byte must be programmed
first. Then the upper byte is programmed. | RW | 0x0006 |
...
count value gets changed to 8. | RW | 0x000d |
...
![Page 1028 figure](images/fig_p1028.png)
...
for 1 entry, and a value of 255 sets the threshold for 256 entries. | RW | 0x00 |
...
sets the threshold for 255 entries. | RW | 0x00 |
...
![Page 1029 figure](images/fig_p1029.png)
...
![Page 1030 figure](images/fig_p1030.png)
...
![Page 1031 figure](images/fig_p1031.png)
...
IC_TX_CMD_BLOCK_DEFAULT | RW | 0x0 |
|  | Enumerated values: |  |  |
...
IDLE state so the Slave part of DW_apb_i2c is Active Reset value: 0x0 | RO | 0x0 |
|  | Enumerated values: |  |  |
...
FIFO is empty - 1: Receive FIFO is not empty Reset value: 0x0 | RO | 0x0 |
|  | Enumerated values: |  |  |
...
empty - 1: Transmit FIFO is empty Reset value: 0x1 | RO | 0x1 |
|  | Enumerated values: |  |  |
...
is full - 1: Transmit FIFO is not full Reset value: 0x1 | RO | 0x1 |
|  | Enumerated values: |  |  |
...
![Page 1036 figure](images/fig_p1036.png)
...
disabled.
Reset value: 0x0
Role of DW_apb_i2c: Master-Transmitter or Slave-Transmitter | RO | 0x000 |
| 22:17 | Reserved. | - | - |
| 16 | ABRT_USER_ABRT: This is a master-mode-only bit. Master has detected the
transfer abort (IC_ENABLE[1])
Reset value: 0x0
Role of DW_apb_i2c: Master-Transmitter | RO | 0x0 |
|  | Enumerated values: |  |  |
...
Reset value: 0x0
Role of DW_apb_i2c: Slave-Transmitter | RO | 0x0 |
|  | Enumerated values: |  |  |
...
arbitration.
Reset value: 0x0
Role of DW_apb_i2c: Master-Transmitter or Slave-Transmitter | RO | 0x0 |
|  | Enumerated values: |  |  |
...
Reset value: 0x0
Role of DW_apb_i2c: Master-Transmitter or Master-Receiver | RO | 0x0 |
|  | Enumerated values: |  |  |
...
Reset value: 0x0
Role of DW_apb_i2c: Master-Receiver | RO | 0x0 |
|  | Enumerated values: |  |  |
...
Reset value: 0x0
Role of DW_apb_i2c: Master | RO | 0x0 |
...
NACK/ACK normally Reset value: 0x0 | RW | 0x0 |
|  | Enumerated values: |  |  |
...
DMA channel. Reset value: 0x0 | RW | 0x0 |
|  | Enumerated values: |  |  |
...
channel. Reset value: 0x0 | RW | 0x0 |
|  | Enumerated values: |  |  |
...
DW_apb_i2c responds with a NACK (by negating ic_data_oe). | RW | 0x1 |
|  | Enumerated values: |  |  |
...
![Page 1046 figure](images/fig_p1046.png)
