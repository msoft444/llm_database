...
![Page 1113 figure](images/fig_p1113.png)
...
![Page 1114 figure](images/fig_p1114.png)
...
![Page 1115 figure](images/fig_p1115.png)
...
![Page 1116 figure](images/fig_p1116.png)
...
![Page 1117 figure](images/fig_p1117.png)
...
![Page 1118 figure](images/fig_p1118.png)
...
![Page 1119 figure](images/fig_p1119.png)
...
![Page 1120 figure](images/fig_p1120.png)
...
![Page 1121 figure](images/fig_p1121.png)
...
![Page 1122 figure](images/fig_p1122.png)
...
![Page 1123 figure](images/fig_p1123.png)
...
![Page 1124 figure](images/fig_p1124.png)
...
![Page 1125 figure](images/fig_p1125.png)
...
![Page 1126 figure](images/fig_p1126.png)
...
value is the next address to be read by this channel. | RW | 0x00000000 |
...
value is the next address to be written by this channel. | RW | 0x00000000 |
...
All other values are reserved. | RW | 0x0 |
|  | Enumerated values: |  |  |
|  | 0x0 → NORMAL |  |  |
|  | 0x1 → TRIGGER_SELF |  |  |
|  | 0xf → ENDLESS |  |  |
...
new transfer sequence, as well as being written to RELOAD. | RW | 0x0000000 |
...
encountered (will not be earlier, or more than 3 transfers later) | WC | 0x0 |
...
encountered (will not be earlier, or more than 5 transfers later) | WC | 0x0 |
| 28:27 | Reserved. | - | - |
...
To terminate a sequence early (and clear the BUSY flag), see CHAN_ABORT. | RO | 0x0 |
...
swapped to reverse order. | RW | 0x0 |
...
0x0 to 0x3a → select DREQ n as TREQ | RW | 0x00 |
|  | Enumerated values: |  |  |
...
default. Set this field to avoid this behaviour. | RW | 0x0 |
...
read or write addresses, based on value of RING_SEL. | RW | 0x0 |
|  | Enumerated values: |  |  |
|  | 0x0 → RING_NONE |  |  |
...
Generally this should be disabled for peripheral-to-memory transfers. | RW | 0x0 |
...
![Page 1130 figure](images/fig_p1130.png)
...
channel will see no loss of throughput. | RW | 0x0 |
...
BUSY will remain high if already high) | RW | 0x0 |
...
This is a trigger register (0xc). Writing a nonzero value will
reload the channel counter and start the channel. | RW | - |
...
![Page 1131 figure](images/fig_p1131.png)
...
![Page 1132 figure](images/fig_p1132.png)
...
channel’s interrupt status will read as 0, ignore writes. | WC | 0x0000 |
...
![Page 1133 figure](images/fig_p1133.png)
...
asserted until INTF0 is cleared. | RW | 0x0000 |
...
as 0 in this register, and ignore writes. | WC | 0x0000 |
...
![Page 1134 figure](images/fig_p1134.png)
...
asserted until INTF1 is cleared. | RW | 0x0000 |
...
![Page 1135 figure](images/fig_p1135.png)
...
asserted until INTF2 is cleared. | RW | 0x0000 |
...
![Page 1136 figure](images/fig_p1136.png)
...
asserted until INTF3 is cleared. | RW | 0x0000 |
...
channel will start if it is currently enabled and not already busy. | SC | 0x0000 |
...
transformed on-the-fly between the result register and the bus. | RW | 0x0 |
...
between the result register and the bus. | RW | 0x0 |
...
![Page 1138 figure](images/fig_p1138.png)
...
completes, the final result can be read from this register. | RW | 0x00000000 |
...
point, it is unsafe to restart the channel. | SC | 0x0000 |
...
one, to minimise silicon area. | RO | - |
...
![Page 1139 figure](images/fig_p1139.png)
...
specified in the channel’s SECCFG register, will not set the LOCK bit. | RW | 0x0 |
| 1 | S: Secure channel. If 1, this channel performs Secure bus accesses. If 0, it
performs Non-secure bus accesses.
If 1, this channel is controllable only from a Secure context. | RW | 0x1 |
...
Secure/Non-secure level, or any context of a higher Secure/Non-secure level. | RW | 0x1 |
...
![Page 1140 figure](images/fig_p1140.png)
...
and timer DREQ 3 is only visible to Secure channels. | RW | 0x1 |
...
Secure) channels. | RW | 0x1 |
| 7 | TIMER2_S: If 1, the TIMER2 register is only accessible from a Secure context,
and timer DREQ 2 is only visible to Secure channels. | RW | 0x1 |
...
and timer DREQ 1 is only visible to Secure channels. | RW | 0x1 |
...
and timer DREQ 0 is only visible to Secure channels. | RW | 0x1 |
...
but can not see data transfers of Secure channels. | RW | 0x1 |
...
![Page 1141 figure](images/fig_p1141.png)
...
Secure, Privileged context. | RW | 0x0000000 |
| 4:0 | Reserved. | - | - |
...
Otherwise readable only from a Secure, Privileged context. | RW | 0x0000000 |
| 4:3 | Reserved. | - | - |
