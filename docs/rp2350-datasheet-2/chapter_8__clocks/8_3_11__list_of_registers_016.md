...
Any other value in this field will set all drive strengths to 0 | RW | 0x0000 |
|  | Enumerated values: |  |  |
|  | 0x9696 → PASS |  |  |
| 15 | Reserved. | - | - |
...
this register resets to div=32 | RW | - |
|  | Enumerated values: |  |  |
|  | 0xaa00 → PASS |  |  |
...
this can be changed on-the-fly | RW | 0x1 |
...
CTRL_FREQ_RANGE or FREQA or FREQB or DIV or PHASE or DORMANT | WC | 0x0 |
| 23:17 | Reserved. | - | - |
| 16 | DIV_RUNNING: post-divider is running
this resets to 0 but transitions to 1 during chip startup | RO | - |
| 15:13 | Reserved. | - | - |
