...
![Page 585 figure](images/fig_p0585.png)
...
and the divided VCO but the output will glitch when doing so. | RW | 0x0 |
| 7:6 | Reserved. | - | - |
...
To save power set high when PLL output not required or bypass=1. | RW | 0x1 |
| 4 | Reserved. | - | - |
| 3 | POSTDIVPD: PLL post divider powerdown
To save power set high when PLL output not required or bypass=1. | RW | 0x1 |
| 2 | DSMPD: PLL DSM powerdown
Nothing is achieved by setting this low. | RW | 0x1 |
| 1 | Reserved. | - | - |
| 0 | PD: PLL powerdown
To save power set high when PLL output not required. | RW | 0x1 |
...
![Page 586 figure](images/fig_p0586.png)
...
![Page 587 figure](images/fig_p0587.png)
