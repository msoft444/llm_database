...
| --- | --- | --- |
| clk gpout0
_ | Clock output to GPIO. Can be used to | N/A |
| clk gpout1
_ | clock external devices or debug on
...
_ |  |  |
| clk ref
_ | Reference clock that is always running
...
![Page 520 figure](images/fig_p0520.png)
...
| --- | --- | --- |
| clk sys
_ | System clock that is always running
unless in DORMANT mode. Runs from
clk ref at power-up, but is typically
_
switched to a PLL. | 150MHz |
| clk peri
_ | Peripheral clock. Typically runs from
clk sys but allows peripherals to run at
_
a consistent speed if clk sys is
_
changed by software. | 12 - 150MHz |
| clk usb
_ | USB reference clock. Must be 48MHz. | 48MHz |
| clk adc
_ | ADC reference clock. Must be 48MHz. | 48MHz |
| clk hstx
_ | HSTX clock. | 150MHz |
