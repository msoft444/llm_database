...
![Page 1294 figure](images/fig_p1294.png)
...
command or the ROM get sys info() API. However note that the
_ _
...
![Page 1295 figure](images/fig_p1295.png)
...
![Page 1296 figure](images/fig_p1296.png)
...
![Page 1297 figure](images/fig_p1297.png)
...
![Page 1298 figure](images/fig_p1298.png)
...
![Page 1299 figure](images/fig_p1299.png)
...
![Page 1300 figure](images/fig_p1300.png)
...
![Page 1301 figure](images/fig_p1301.png)
...
![Page 1302 figure](images/fig_p1302.png)
...
![Page 1303 figure](images/fig_p1303.png)
...
![Page 1304 figure](images/fig_p1304.png)
...
![Page 1305 figure](images/fig_p1305.png)
...
for practical purposes CHIPID may be treated as unique. | RO | - |
...
![Page 1306 figure](images/fig_p1306.png)
...
DISABLE_BOOTSEL_USB_PICOBOOT_IFC flag in BOOT_FLAGS0. | RO | - |
...
![Page 1307 figure](images/fig_p1307.png)
...
registers in their reset state. | RO | - |
...
![Page 1308 figure](images/fig_p1308.png)
...
package, and 30 in the QFN60 package. (ECC) | RO | - |
...
![Page 1309 figure](images/fig_p1309.png)
...
permanently disable the RISC-V cores. | RO | - |
...
that interact with the partition table. | RO | - |
...
![Page 1310 figure](images/fig_p1310.png)
...
start at a 32-bit-aligned address in the ECC read data address window. | RO | - |
...
automatically the first time a binary with a rollback version is booted. | RO | - |
...
FLASH_PARTITION_SLOT_SIZE is valid before setting this bit | RO | - |
| 5 | FLASH_DEVINFO_ENABLE: Mark FLASH_DEVINFO as containing valid, ECC’d
data which describes external flash devices. | RO | - |
| 4 | FAST_SIGCHECK_ROSC_DIV: Enable quartering of ROSC divisor during
signature check, to reduce secure boot time | RO | - |
...
![Page 1311 figure](images/fig_p1311.png)
...
frequency of 48 MHz. | RO | - |
| 1 | ENABLE_BOOTSEL_LED: Enable bootloader activity LED. If set,
bootsel_led_cfg is assumed to be valid | RO | - |
| 0 | Reserved. | - | - |
...
await further instruction over USB or UART. | RO | - |
...
200 milliseconds (DOUBLE_TAP_DELAY=3) is a good intermediate value. | RO | - |
| 15:12 | Reserved. | - | - |
...
![Page 1312 figure](images/fig_p1312.png)
...
![Page 1315 figure](images/fig_p1315.png)
...
interface, such as BOOTSEL mode (nsboot). | RO | - |
...
value of 1 means a reference divisor of 2 (for exceptionally fast XIN inputs) | RO | - |
...
mirrored USB routing (deliberate or accidental). | RO | - |
...
![Page 1317 figure](images/fig_p1317.png)
...
entry of the USB_WHITE_LABEL struct (index 1) | RO | - |
...
entry of the USB_WHITE_LABEL struct (index 0) | RO | - |
...
USB_WHITE_LABEL_ADDR value + index): | RO | - |
|  | Enumerated values: |  |  |
...
a word-aligned location in the ECC read data address window. | RO | - |
...
![Page 1320 figure](images/fig_p1320.png)
...
through 0x20082000) and must be word-aligned. | RO | - |
...
![Page 1321 figure](images/fig_p1321.png)
...
![Page 1322 figure](images/fig_p1322.png)
...
![Page 1323 figure](images/fig_p1323.png)
...
matching key has been entered. | RO | - |
|  | Enumerated values: |  |  |
|  | 0x0 → READ_ONLY |  |  |
|  | 0x1 → INACCESSIBLE |  |  |
| 5:3 | KEY_R: Index 1-6 of a hardware key which must be entered to grant read
access, or 0 if no such key is required. | RO | - |
...
effect, and no corresponding SW_LOCKx registers. | RO | - |
|  | Enumerated values: |  |  |
...
temporarily (until next OTP reset) using the SW_LOCKx registers. | RO | - |
|  | Enumerated values: |  |  |
