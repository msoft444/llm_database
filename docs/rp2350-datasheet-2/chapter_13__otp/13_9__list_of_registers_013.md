...
![Page 1281 figure](images/fig_p1281.png)
...
![Page 1282 figure](images/fig_p1282.png)
...
![Page 1283 figure](images/fig_p1283.png)
...
read-only to Non-secure code. | RW | - |
|  | Enumerated values: |  |  |
|  | 0x0 → READ_WRITE |  |  |
|  | 0x1 → READ_ONLY |  |  |
|  | 0x3 → INACCESSIBLE |  |  |
...
![Page 1285 figure](images/fig_p1285.png)
...
![Page 1286 figure](images/fig_p1286.png)
...
automatically clear to 0. | RO | 0x00000000 |
...
![Page 1287 figure](images/fig_p1287.png)
...
![Page 1288 figure](images/fig_p1288.png)
...
true only if the BIST was initiated without the fix option. | RO | - |
...
![Page 1289 figure](images/fig_p1289.png)
...
secure of these enrolled key values has not been provided over SWD. | RW | 0x0 |
| 7:4 | Reserved. | - | - |
...
secure of these enrolled key values not yet provided over SWD. | RW | 0x0 |
...
![Page 1290 figure](images/fig_p1290.png)
...
these enrolled key values has not been provided over SWD. | RW | 0x0 |
...
![Page 1292 figure](images/fig_p1292.png)
...
to prevent later stages from unlocking it via watchdog reset. | RW | 0x0 |
...
chance to soft lock OTP pages containing sensitive data. | WC | 0x0 |
