...
![Page 872 figure](images/fig_p0872.png)
...
POWMAN_CHIP_RESET.
This register is Secure read/write only. | RW | 0x5bad |
|  | Enumerated values: |  |  |
...
is YES.
This register is Secure read/write only. | RW | 0x0000 |
|  | Enumerated values: |  |  |
...
![Page 874 figure](images/fig_p0874.png)
...
LOCK. This register is Secure read/write only. | RW | 0x00 |
