...
![Page 1367 figure](images/fig_p1367.png)
...
![Page 1368 figure](images/fig_p1368.png)
...
between V and V (the undefined logic region).
IL IH
When the pad is set as an input (input enable is enabled and output enable is disabled) and the voltage
on the pad is within the undefined logic region, the leakage current exceeds the standard specified I
IN
