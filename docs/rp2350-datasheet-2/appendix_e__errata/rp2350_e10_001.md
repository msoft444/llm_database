...
| Reference | RP2350-E3 |
| --- | --- |
| Summary | In QFN-60 package, GPIO NSMASK controls wrong PADS registers
_ |
...
take this remapping into account. Consequently, in the QFN-60 package only, the GPIO NSMASK0 register bits
_
are applied to registers for the wrong pads. Specifically, PADS BANK0 registers 29 through 0 are controlled
_
by the concatenation of GPIO NSMASK bits 47 through 44, 39 through 33, 30 through 28, 24 through 17 and
_
...
read/write its assigned PADS BANK0 registers.
_ |
