...
| 0x00000014 | 16-bit pointer | Pointer to ROM entry table (BOOTROM ROMTABLE START)
_ _ |
| 0x00000016 | 16-bit pointer | Pointer to a helper function (rom table lookup val())
_ _ _ |
| 0x00000018 | 16-bit pointer | Pointer to a helper function (rom table lookup entry())
_ _ _ |

| Address | Contents | Description |
| --- | --- | --- |
| 0x00007df6 | 16-bit pointer | Pointer to ROM entry table (BOOTROM ROMTABLE START)
_ _ |
| 0x00007df8 | 16-bit pointer | Pointer to a helper function (rom table lookup val())
_ _ _ |
| 0x00007dfa | 16-bit pointer | Pointer to a helper function (rom table lookup entry())
_ _ _ |
