...
| --- | --- | --- | --- |
| LAST_ITEM | 1 + s0 + s1 | 1 | 0xff (size_flag == 1, item type == BLOCK ITEM LAST)
_ _ |
...
| Word | Bytes | Value |
| --- | --- | --- |
| 0 | 1 | 0x48 (size_flag == 0, item_type == PICOBIN BLOCK ITEM 1BS VERSION)
_ _ _ _ |
|  | 1 | 2 + ((num otp row entries != 0) + num row entries + 1) / 2
_ _ _ _ _ |
|  | 1 | 0x00 (pad) |
...
![Page 421 figure](images/fig_p0421.png)
...
| Word | Bytes | Value |
| --- | --- | --- |
| 0 | 1 | 0x47 (size_flag == 0, item_type == PICOBIN BLOCK ITEM 1BS HASH DEF)
_ _ _ _ _ |
|  | 1 | 0x03 (size_lo) |
|  | 1 | 0x00 (pad) |
|  | 1 | 0x01 (PICOBIN HASH SHA-256)
_ _ |
...
| Word | Bytes | Value |
| --- | --- | --- |
| 0 | 1 | 0x09 (size_flag == 0, item_type == PICOBIN BLOCK ITEM HASH VALUE)
_ _ _ _ |
