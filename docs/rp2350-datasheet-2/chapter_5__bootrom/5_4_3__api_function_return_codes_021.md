...
| BOOTROM OK
_ | 0 | The function executed successfully |
| BOOTROM ERROR NOT PERMITTED
_ _ _ | -4 | The operation was disallowed by a security constraint |
| BOOTROM ERROR INVALID ARG
_ _ _ | -5 | One or more parameters passed to the function is outside
