...
![Page 422 figure](images/fig_p0422.png)
...
| Word | Bytes | Value |
| --- | --- | --- |
| 0 | 1 | 0x4b (size_flag == 0, item_type == PICOBIN BLOCK ITEM SIGNATURE)
_ _ _ |
|  | 1 | 0x21 (Block size in words) |
|  | 1 | 0x00 (pad) |
|  | 1 | 0x01 (PICOBIN SIGNATURE SECP256K1)
_ _ |
...
| Word | Bytes | Value |
| --- | --- | --- |
| 0 | 1 | 0x42 (size_flag == 0, item_type == PICOBIN BLOCK ITEM 1BS IMAGE TYPE)
_ _ _ _ _ |
...
![Page 423 figure](images/fig_p0423.png)
...
![Page 424 figure](images/fig_p0424.png)

RP2350 Datasheet

| Word | Bytes | Value |
| --- | --- | --- |
| 0 | 1 | 0x06 (size_flag == 0, item_type == PICOBIN BLOCK ITEM LOAD MAP)
_ _ _ _ |
|  | 2 | 1 + num entries * 3 (Block size in words)
_ |
...
| 1-3 | Load Map | Entry 0 |
|  | 4 | XIP SRAM BASE (storage_start_address)
_ _ |
|  | 4 | XIP SRAM BASE (runtime_start_address)
_ _ |
...
![Page 425 figure](images/fig_p0425.png)
...
| Word | Bytes | Value |
| --- | --- | --- |
| 0 | 1 | 0x03 (size_flag == 0, item_type == PICOBIN BLOCK ITEM 1BS VECTOR TABLE)
_ _ _ _ _ |
...
| Word | Bytes | Value |
| --- | --- | --- |
| 0 | 1 | 0x44 (size_flag == 0, item_type == PICOBIN BLOCK ITEM 1BS ENTRY POINT)
_ _ _ _ _ |
...
| Word | Bytes | Value |
| --- | --- | --- |
| 0 | 1 | 0x05 (size_flag == 0, item_type == PICOBIN BLOCK ITEM 1BS ROLLING WINDOW DELTA)
_ _ _ _ _ _ |
|  | 1 | 0x02 (Block size in words) |
|  | 2 | 0x0000 (pad) |
