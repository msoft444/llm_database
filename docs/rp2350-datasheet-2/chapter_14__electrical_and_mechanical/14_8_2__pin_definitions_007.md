...
![Page 1336 figure](images/fig_p1336.png)
...
| Digital IO (FT) | Bi-directional | tolerate voltages up to 5.5 V, provided IOVDD is powered to 3.3 V.
...
Input (Analogue) | Standard Digital and ADC input. Programmable Pull-Up, Pull-Down,
...
| Analogue (XOSC) |  | Oscillator input pins for attaching a 12 MHz crystal. Alternatively, XIN
...
![Page 1337 figure](images/fig_p1337.png)
...
![Page 1338 figure](images/fig_p1338.png)
...
| --- | --- | --- | --- | --- | --- | --- |
| QSPI SD3
_ | 55 | 70 | Digital IO | QSPI IOVDD
_ | Pull-Up | QSPI data |
| QSPI SCLK
_ | 56 | 71 | Digital IO | QSPI IOVDD
_ | Pull-Down | QSPI clock |
| QSPI SD0
_ | 57 | 72 | Digital IO | QSPI IOVDD
_ | Pull-Down | QSPI data |
| QSPI SD2
_ | 58 | 73 | Digital IO | QSPI IOVDD
_ | Pull-Up | QSPI data |
| QSPI SD1
_ | 59 | 74 | Digital IO | QSPI IOVDD
_ | Pull-Down | QSPI data |
| QSPI SS
_ | 60 | 75 | Digital IO | QSPI IOVDD
_ | Pull-Up | QSPI chip
select / USB
BOOTSEL |
...
| --- | --- | --- | --- | --- | --- |
| XIN | 21 | 30 | Analogue (XOSC) | IOVDD | Crystal oscillator.
XIN may also be
driven by a square
wave. |
...
| Name | QFN-60 Number | QFN-80 Number | Type | Power Domain | Reset State | Description |
| --- | --- | --- | --- | --- | --- | --- |
| RUN | 26 | 35 | Digital In (FT) | IOVDD | Pull-Up | Chip enable /
reset n
_ |
| SWCLK | 24 | 33 | Digital In (FT) | IOVDD | Pull-Up | Serial Wire
Debug clock |
| SWDIO | 25 | 34 | Digital IO (FT) | IOVDD | Pull-Up | Serial Wire
Debug data |
