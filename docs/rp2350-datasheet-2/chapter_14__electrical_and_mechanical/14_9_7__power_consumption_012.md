...
| --- | --- | --- | --- | --- | --- |
| VOUT_OK
TH.DEASSERT | VOUT OK de-
_
assertion
threshold | 84 | 87 | 90 | % of selected
output voltage |
| f
sw | switching
frequency |  | 3 |  | MHz |
...
![Page 1347 figure](images/fig_p1347.png)
...
| Use Case | Condition | VREG VIN (μA)
_ | VREG AVDD
_
(μA) | IOVDD (μA) | QSPI IOVDD
_
(μA | ADC IOVDD
_
(μA) | USB OTP VDD
...
| USB Boot
mode | Bus Idle
(average) | 6530 | 220 | 437 | 22 | 1 | 375 | 25 |
|  | During Boot
(peak) |  |  |  |  |  | 6050 |  |
|  | During UF2
write
(average) |  |  |  |  |  | 1280 |  |
| hello serial
_ |  | 14690 | 216 | 506 | 22 | 1 | 62 | 51.1 |
| hello usb
_ |  | 14700 | 216 | 453 | 22 | 1 | 570 | 52.7 |
| hello adc
_ |  | 14680 | 216 | 506 | 22 | 142 | 62 | 51.6 |
| CoreMark
benchmark | Single core
@150MHz | 11000 | 212 | 455 | 22 | 1 | 90 | 38.7 |
