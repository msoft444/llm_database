...
*Table 819. USBPHY_DP_STATUS Register IO_QSPI: USBPHY_DP_CTRL Register Offset: 0x004*

![Page 762 figure](images/fig_p0762.png)

*Table 820. USBPHY_DP_CTRL Register*
...
*Table 821. USBPHY_DM_STATUS Register IO_QSPI: USBPHY_DM_CTRL Register Offset: 0x00c*
...
*Table 822. USBPHY_DM_CTRL Register*
...
*Table 823. GPIO_QSPI_SCLK_STA TUS Register IO_QSPI: GPIO_QSPI_SCLK_CTRL Register Offset: 0x014*

![Page 765 figure](images/fig_p0765.png)

*Table 824. GPIO_QSPI_SCLK_CTR L Register*
...
*Table 825. GPIO_QSPI_SS_STATU S Register IO_QSPI: GPIO_QSPI_SS_CTRL Register Offset: 0x01c*
...
*Table 826. GPIO_QSPI_SS_CTRL Register*
...
*Table 827. GPIO_QSPI_SD0_STAT US Register IO_QSPI: GPIO_QSPI_SD0_CTRL Register Offset: 0x024*

![Page 768 figure](images/fig_p0768.png)

*Table 828. GPIO_QSPI_SD0_CTRL Register*
...
*Table 829. GPIO_QSPI_SD1_STAT US Register IO_QSPI: GPIO_QSPI_SD1_CTRL Register Offset: 0x02c*
...
*Table 830. GPIO_QSPI_SD1_CTRL Register*
...
*Table 831. GPIO_QSPI_SD2_STAT US Register IO_QSPI: GPIO_QSPI_SD2_CTRL Register Offset: 0x034*

![Page 771 figure](images/fig_p0771.png)

*Table 832. GPIO_QSPI_SD2_CTRL Register*
...
*Table 833. GPIO_QSPI_SD3_STAT US Register IO_QSPI: GPIO_QSPI_SD3_CTRL Register Offset: 0x03c*
...
*Table 834. GPIO_QSPI_SD3_CTRL Register*
...
*Table 835. IRQSUMMARY_PROC0 _SECURE Register IO_QSPI: IRQSUMMARY_PROC0_NONSECURE Register Offset: 0x204*
...
*Table 836. IRQSUMMARY_PROC0 _NONSECURE Register IO_QSPI: IRQSUMMARY_PROC1_SECURE Register Offset: 0x208*
...
*Table 837. IRQSUMMARY_PROC1 _SECURE Register*
...
*Table 838. IRQSUMMARY_PROC1 _NONSECURE Register IO_QSPI: IRQSUMMARY_COMA_WAKE_SECURE Register Offset: 0x210*
...
*Table 839. IRQSUMMARY_COMA_ WAKE_SECURE Register IO_QSPI: IRQSUMMARY_COMA_WAKE_NONSECURE Register Offset: 0x214*
...
*Table 840. IRQSUMMARY_COMA_ WAKE_NONSECURE Register*
...
*Table 848. DORMANT_WAKE_INT E Register*
...
*Table 849. DORMANT_WAKE_INT F Register*
...
*Table 850. DORMANT_WAKE_INT S Register*
