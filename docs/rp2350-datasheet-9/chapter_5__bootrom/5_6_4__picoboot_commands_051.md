...
| --- | --- | --- | --- |
| 0x08 | bCmdId | 0x01 (EXCLUSIVE ACCESS) _ |  |
| 0x09 | bCmdSize | 0x01 |  |
| 0x0c | dTransferLength | 0x00000000 |  |
| 0x10 | bExclusive | NOT EXCLUSIVE (0) _ | No restriction on USB Mass Storage operation |
...
|  |  | EXCLUSIVE AND EJECT (2) _ _ | Lock the USB Mass Storage Interface out by marking the drive media as not present (ejecting the drive) |
...
*Table 459. PICOBOOT EXCLUSIVE_ACCESS command structure*
...
*Table 460. PICOBOOT FLASH_ERASE command structure*
...
*Table 463. PICOBOOT EXIT_XIP command structure*
...
*Table 466. PICOBOOT GET_INFO command structure*
...
*Table 467. PICOBOOT OTP_READ command structure*
...
*Table 468. PICOBOOT OTP_WRITE command structure*
