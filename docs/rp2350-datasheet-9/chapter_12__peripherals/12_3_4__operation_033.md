...
*Figure 95. Motorola SPI frame format, single transfer, with SPO=0 and SPH=0 In this configuration, during idle periods:*
...
*Figure 96. Motorola SPI frame format with SPO=0 and SPH=1, single and continuous transfers In this configuration, during idle periods:*
...
*Figure 98. Motorola SPI frame format, continuous transfer, with SPO=1 and SPH=0 In this configuration, during idle periods:*
...
*Figure 99. Motorola SPI frame format with SPO=1 and SPH=1, single and continuous transfers In Figure 99, Q is an undefined signal. In this configuration, during idle periods:*
...
*Figure 105. SPI master coupled to a PrimeCell SPI master PL022 configured SSP slave*
