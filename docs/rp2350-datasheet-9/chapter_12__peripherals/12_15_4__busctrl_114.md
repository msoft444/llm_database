...
*Table 1326. Bus fabric performance event select for PERFCTR1*
...
*Table 1328. BUSCTRL: PERFSEL2 Register Offset: 0x20 Description Bus fabric performance event select for PERFCTR2*
...
*Table 1330. Bus fabric performance event select for PERFCTR3*
