...
*Table 368. MSTATUS RVCSR: MISA Register Offset: 0x301 Description Summary of ISA extension support*
...
*Table 370. MEDELEG RVCSR: MIDELEG Register Offset: 0x303*
...
*Table 371. MIDELEG RVCSR: MIE Register Offset: 0x304 Description Machine interrupt enable register*
...
*Table 372. MIE RVCSR: MTVEC Register Offset: 0x305 Description Machine trap handler base address.*
...
*Table 374. MCOUNTEREN Register RVCSR: MENVCFG Register Offset: 0x30a Description*
...
*Table 375. MENVCFG RVCSR: MSTATUSH Register Offset: 0x310*
...
*Table 376. MSTATUSH RVCSR: MENVCFGH Register Offset: 0x31a Description*
...
*Table 377. RVCSR: MCOUNTINHIBIT Register Offset: 0x320 Description Count inhibit register for mcycle/minstret*
...
*Table 379. MHPMEVENT3, MHPMEVENT4, …, MHPMEVENT30, MHPMEVENT31 Registers RVCSR: MSCRATCH Register Offset: 0x340*
...
*Table 380. RVCSR: MEPC Register Offset: 0x341*
...
*Table 381. MEPC RVCSR: MCAUSE Register Offset: 0x342*
...
*Table 382. MCAUSE RVCSR: MTVAL Register Offset: 0x343*
...
*Table 383. MTVAL RVCSR: MIP Register Offset: 0x344 Description Machine interrupt pending*
...
*Table 384. MIP RVCSR: PMPCFG0 Register Offset: 0x3a0 Description*
...
*Table 389. PMPADDR0 RVCSR: PMPADDR1 Register Offset: 0x3b1*
...
*Table 390. PMPADDR1 RVCSR: PMPADDR2 Register Offset: 0x3b2*
...
*Table 391. PMPADDR2 RVCSR: PMPADDR3 Register Offset: 0x3b3*
...
*Table 393. PMPADDR4 RVCSR: PMPADDR5 Register Offset: 0x3b5*
...
*Table 394. PMPADDR5 RVCSR: PMPADDR6 Register Offset: 0x3b6*
...
*Table 395. PMPADDR6 RVCSR: PMPADDR7 Register Offset: 0x3b7*
...
*Table 396. PMPADDR7 RVCSR: PMPADDR8 Register Offset: 0x3b8*
...
*Table 398. PMPADDR9 RVCSR: PMPADDR10 Register Offset: 0x3ba*
...
*Table 399. RVCSR: PMPADDR11 Register Offset: 0x3bb*
...
*Table 400. RVCSR: PMPADDR12 Register Offset: 0x3bc*
...
*Table 401. RVCSR: PMPADDR13 Register Offset: 0x3bd*
...
*Table 402. RVCSR: PMPADDR14 Register Offset: 0x3be*
...
*Table 403. RVCSR: PMPADDR15 Register Offset: 0x3bf*
...
*Table 404. RVCSR: TSELECT Register Offset: 0x7a0*
...
*Table 405. TSELECT RVCSR: TDATA1 Register Offset: 0x7a1 Description Trigger configuration data 1*
...
*Table 407. TDATA2 RVCSR: DCSR Register Offset: 0x7b0 Description*
...
*Table 409. DPC RVCSR: MCYCLE Register Offset: 0xb00 Description Machine-mode cycle counter, low half*
...
*Table 410. MCYCLE RVCSR: MINSTRET Register Offset: 0xb02 Description Machine-mode instruction retire counter, low half*
...
*Table 412. MHPMCOUNTER3, MHPMCOUNTER4, …, MHPMCOUNTER30, MHPMCOUNTER31 Registers RVCSR: MCYCLEH Register Offset: 0xb80 Description Machine-mode cycle counter, high half*

| Bits | Description | Type | Reset |
| --- | --- | --- | --- |
| 31:0 | Counts up once per 1 << 32 cycles, when mcountinhibit.cy is 0. Disabled by default to save power. | RW | 0x00000000 |

*Table 413. MCYCLEH RVCSR: MINSTRETH Register Offset: 0xb82 Description Machine-mode instruction retire counter, low half*
...
*Table 415. MHPMCOUNTER3H, MHPMCOUNTER4H, …, MHPMCOUNTER30H, MHPMCOUNTER31H Registers RVCSR: PMPCFGM0 Register Offset: 0xbd0*
...
*Table 417. MEIEA RVCSR: MEIPA Register Offset: 0xbe1 Description External interrupt pending array*
...
*Table 418. MEIPA RVCSR: MEIFA Register Offset: 0xbe2 Description External interrupt force array*
...
*Table 419. MEIFA RVCSR: MEIPRA Register Offset: 0xbe3 Description External interrupt priority array*
...
*Table 421. MEINEXT RVCSR: MEICONTEXT Register Offset: 0xbe5 Description External interrupt context register*
...
*Table 423. MSLEEP RVCSR: DMDATA0 Register Offset: 0xbff*
...
*Table 424. DMDATA0 RVCSR: CYCLE Register Offset: 0xc00*

| Bits | Description | Type | Reset |
| --- | --- | --- | --- |
| 31:0 | Read-only U-mode alias of mcycle, accessible when mcounteren.cy is set | RO | 0x00000000 |

*Table 425. CYCLE RVCSR: INSTRET Register Offset: 0xc02*
...
*Table 426. INSTRET RVCSR: CYCLEH Register Offset: 0xc80*
...
*Table 427. CYCLEH RVCSR: INSTRETH Register Offset: 0xc82*

| Bits | Description | Type | Reset |
| --- | --- | --- | --- |
| 31:0 | Read-only U-mode alias of minstreth, accessible when mcounteren.ir is set | RO | 0x00000000 |

*Table 428. INSTRETH RVCSR: MVENDORID Register Offset: 0xf11 Description Vendor ID*
...
*Table 429. RVCSR: MARCHID Register Offset: 0xf12*

| Bits | Description | Type | Reset |
| --- | --- | --- | --- |
| 31:0 | Architecture ID (Hazard3) | RO | 0x0000001b |

*Table 430. MARCHID RVCSR: MIMPID Register Offset: 0xf13*

| Bits | Description | Type | Reset |
| --- | --- | --- | --- |
| 31:0 | Implementation ID. On RP2350 this reads as 0x86fc4e3f, which is release v1.0-rc1 of Hazard3. | RO | 0x86fc4e3f |

*Table 431. MIMPID RVCSR: MHARTID Register Offset: 0xf14 Description Hardware thread ID*
...
*Table 432. MHARTID RVCSR: MCONFIGPTR Register Offset: 0xf15*
